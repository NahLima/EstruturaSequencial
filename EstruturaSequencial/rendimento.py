...
kgLimite = 50
peixeKG = float(input('digite a quantidade de peixes que pegou em kg: '))

if peixeKG > kgLimite:
    calculoMulta = round((peixeKG - kgLimite) * 4.00 , 2)
    print(f'você precisa pagar o excedente de: {calculoMulta}')
